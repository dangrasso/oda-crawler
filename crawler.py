...
class Crawler(ABC):
    ...
    def __init__(self, url, max, frontier: Frontier, visited: set[str]):
    ...
    def parse_links(self, url: str, html: str) -> set[str]:
        soup = BeautifulSoup(html, "html.parser") # IDEA: optimize by moving 'out' the html parsing
    ...
    def visit(self, url: str) -> None:
        ...
        rnd_delay = round(random.uniform(0.5, 1.5), 1)
        sleep(rnd_delay) 
